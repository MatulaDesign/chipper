...
export declare function newChip<T = IData>(data: T): IChip<any>;
export declare function equalityAction(chop: any, chip: any): "skip" | "warn" | "update";
export declare function chopper<T = IData>(chop: IChip, update: IUpdate<T>): IChip<any>;
